"""
Django settings for bilimClassProject project.
...
INSTALLED_APPS = [
    ...
    'bilimClassApp',
    # '.apps.UsersConfig', # Вместо просто 'users'
]
...
ROOT_URLCONF = 'bilimClassProject.urls'
...
WSGI_APPLICATION = 'bilimClassProject.wsgi.application'
